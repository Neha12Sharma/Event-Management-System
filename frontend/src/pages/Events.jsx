...
import { mockGetEvents, INITIAL_CATEGORIES } from '../api/mockData';
...
export default function Events() {
    ...
    const fetchEvents = useCallback(() => {
        ...
        api.get('/events', { params }).then(r => {
            if (r.data?.events) {
                ...
                const mock = mockGetEvents({ search, category, upcoming, page, limit: 9 });
    ...
    useEffect(() => {
        api.get('/events/categories')
            .then(r => { if (Array.isArray(r.data)) setCategories(r.data); else setCategories(INITIAL_CATEGORIES); })
